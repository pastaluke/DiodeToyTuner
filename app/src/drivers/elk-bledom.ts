    ...
    return {
      ...
      channels: [
        { id: "power", label: "Power", kind: "power", steps: 2,
          info: "Master switch: cuts or restores drive current to the strip." },
        { id: "r", label: "Red", kind: "r", steps: 256, wavelengthNm: 625,
          info: "PWM duty cycle of the red diode rail (~625 nm) — the fraction of time those diodes conduct. True 8-bit: 256 levels." },
